...
HD_PWD='/home/jun-i/Work/zynq_practice/signal_flip_ipuse/signal_flip_ipuse.runs/design_1_signal_flip_myip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_signal_flip_myip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_signal_flip_myip_0_0.tcl
